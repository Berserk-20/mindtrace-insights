  ...
  return (
    <div className="flex items-center justify-center min-h-screen relative overflow-hidden bg-background">
      ...
      <div className="absolute inset-0 opacity-30">
        ...
        <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-cyan-500/20 rounded-full blur-[120px] animate-pulse" style={{ animationDelay: '1s' }}></div>
      </div>
      ...
      <Card className="w-[420px] relative z-10 card-surface shadow-xl">
        <CardHeader className="space-y-3">
          ...
          <CardDescription className="text-muted-foreground">Get started with real-time behavioral intelligence</CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <CardFooter className="justify-center border-t border-border pt-6">
          <p className="text-sm text-muted-foreground">
            Already have an account? <Link to="/login" className="text-cyan-500 hover:text-cyan-600 hover:underline font-medium">Login</Link>
          </p>
        </CardFooter>
      </Card>
    </div>
